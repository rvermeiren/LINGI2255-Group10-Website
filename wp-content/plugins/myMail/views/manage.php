...
?>
			...
			<p>
				...
				<select name="dateformat">
					...
					<option value="<?php $d = get_option( 'date_format' ) . ' ' . get_option( 'time_format' );
echo $d?>">
					<?php echo $d . ' - (' . date( $d, current_time( 'timestamp' ) ) . ')'; ?>
					</option>
					<option value="<?php $d = get_option( 'date_format' );
echo $d?>">
					<?php echo $d . ' - (' . date( $d, current_time( 'timestamp' ) ) . ')'; ?>
					</option>
					<option value="<?php $d = 'Y-d-m H:i:s';
echo $d?>">
					<?php echo $d . ' - (' . date( $d, current_time( 'timestamp' ) ) . ')'; ?>
					</option>
					<option value="<?php $d = 'Y-d-m';
echo $d?>">
					<?php echo $d . ' - (' . date( $d, current_time( 'timestamp' ) ) . ')'; ?>
					</option>
				</select>
			...
			<p>
				<label><?php _e( 'Separator for CSV output', 'mymail' )?>:
				<select name="separator">
					<option value=";" selected>;</option>
					<option value="," >,</option>
					<option value="|" >|</option>
					<option value="tab" ><?php _e( '[Tab]', 'mymail' );?></option>
				</select>
				</label>
			</p>
			<p>
