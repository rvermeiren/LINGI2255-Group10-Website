...
<?php }?>
<?php if ( !$is_new ):  ?>
<a href="#TB_inline?&width=1200&height=600&inlineId=useitbox" class="add-new-h2" id="use-it"><?php _e( 'Use it!', 'mymail' );?></a>
<?php endif;?>
</h2>
<?php if ( !$is_new ): ?>
...
<?php endif;?>
<div id="titlewrap">
	<input type="text" class="widefat" name="mymail_data[name]" size="30" value="<?php echo esc_attr( $form->name ) ?>" id="title" spellcheck="true" autocomplete="off" placeholder="<?php _e( 'Enter Form Name', 'mymail' );?>">
...
?>> <?php _e( 'use this form as user profile.', 'mymail' );?>
...
?>
								...
								<tr><td><?php _e( 'redirect after confirm', 'mymail' );?></td><td><input type="text" name="mymail_data[confirmredirect]" class="widefat" value="<?php if ( isset( $form->confirmredirect ) ) {
	...
	<div class="useit-wrap">
		<div class="useit-nav">
			<div class="mainnav contextual-help-tabs hide-if-no-js">
				<ul>
					<li><a href="#shortcode" class="nav-shortcode"><?php _e( 'Shortcode', 'mymail' )?></a></li>
					<li><a href="#subscriber-button" class="nav-subscriber-button"><?php _e( 'Subscriber Button', 'mymail' )?></a></li>
					<li><a href="#form-html" class="nav-form-html"><?php _e( 'Form HTML', 'mymail' )?></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="useit-tabs">
			...
			<div id="tab-intro" class="useit-tab">
				<h3><?php _e( 'Use your form as', 'mymail' )?>&hellip;</h3>

				<h4>&hellip; <?php _e( 'Shortcode', 'mymail' )?></h4>
				<p class="description"><?php _e( 'Use a shortcode on a blog post, page or wherever they are excepted.', 'mymail' )?> <?php echo sprintf( __( 'Read more about shortcodes at %s', 'mymail' ), '<a href="https://codex.wordpress.org/Shortcode">WordPress Codex</a>' ) ?></p>

				<h4>&hellip; <?php _e( 'Widget', 'mymail' )?></h4>
				...
				<h4>&hellip; <?php _e( 'Subscriber Button', 'mymail' )?></h4>
				<p class="description"><?php _e( 'Embed your form on any site, no matter if it is your current or a third party one. It\'s similar to the Twitter button.', 'mymail' )?></p>

				<h4>&hellip; HTML</h4>
				<p class="description"><?php _e( 'Use your form via the HTML markup. This is often required by third party plugins. You can choose between an iframe or the raw HTML.', 'mymail' )?></p>
			</div>

			<div id="tab-shortcode" class="useit-tab">
				<h3><?php _e( 'Shortcode', 'mymail' )?></h3>
				<input type="text" class="code widefat" value="[newsletter_signup_form id=<?php echo $id ?>]">
				<p class="description"><?php _e( 'Use this shortcode wherever they are excepted.', 'mymail' )?></p>
			</div>

			<div id="tab-subscriber-button" class="useit-tab">
				<h3><?php _e( 'Subscriber Button', 'mymail' )?></h3>
...
?>
				<div class="wrapper">
					...
					<h4><?php _e( 'Button Style', 'mymail' )?></h4>
				...
				<div class="wrapper-left">
					...
					<h4><?php _e( 'Button Options', 'mymail' )?></h4>
					...
					<div class="button-options-wrap">
						...
						<h4><?php _e( 'Subscriber Count', 'mymail' )?></h4>
					...
					<div class="wrapper-right">
						...
						<h4><?php _e( 'Preview and Code', 'mymail' )?></h4>
			...
			<div id="tab-form-html" class="useit-tab">
				...
				<h3><?php _e( 'Form HTML', 'mymail' )?></h3>

				<h4><?php _e( 'iFrame Version', 'mymail' )?></h4>
				...
				<h4><?php _e( 'HTML Version', 'mymail' )?></h4>
