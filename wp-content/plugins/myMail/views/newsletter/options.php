...
?>
	<ul class="colors<?php if ( count( array_count_values( $original_names ) ) > 1 ) {
	echo ' has-labels';
}
...
?>
				<li><a title="<?php echo basename( $file ); ?>" data-file="<?php echo $file ?>" style="background-image:url(<?php echo $custombgsuri . $file ?>)"<?php if ( $custombgsuri . $file == $value ) {
			echo ' class="active"';
		}
		?>>&nbsp;</a></li>
				<?php
...
?>
			<ul data-base="<?php echo MYMAIL_URI ?>">
				<li><a title="<?php _e( 'none', 'mymail' )?>" data-file="" <?php if ( !$value ) {
	echo ' class="active"';
}
?>><?php _e( 'none', 'mymail' )?></a></li>
		<?php
...
?>
				<li><a title="<?php echo basename( $file ); ?>" data-file="<?php echo $file ?>" style="background-image:url(<?php echo MYMAIL_URI . $file ?>)"<?php if ( MYMAIL_URI . $file == $value ) {
		echo ' class="active"';
	}
	?>>&nbsp;</a></li>
				<?php
