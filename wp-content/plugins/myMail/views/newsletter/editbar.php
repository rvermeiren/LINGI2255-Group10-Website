 ...
 *
 *
 * @param unknown $qtInit
 * @param unknown $editor_id
 * @return unknown
 */
function mymail_quicktags_settings( $qtInit, $editor_id ) {
	$qtInit['buttons'] = apply_filters('mymail_editor_quicktags', 'strong,em,link,block,del,img,ul,ol,li,spell,close');
	return $qtInit;
}
...
$toolbar1 = (string) apply_filters( 'mymail_editor_toolbar1', 'bold,italic,underline,strikethrough,|,bullist,numlist,|,alignleft,aligncenter,alignright,alignjustify,|,forecolor,backcolor,|,undo,redo,|,link,unlink,|,removeformat' );
$toolbar2 = (string) apply_filters( 'mymail_editor_toolbar2', '' );
$toolbar3 = (string) apply_filters( 'mymail_editor_toolbar3', '' );

$editor_height = 295;
if($toolbar2) $editor_height -= 30;
if($toolbar3) $editor_height -= 60;
