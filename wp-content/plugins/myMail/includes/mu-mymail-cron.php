...
Description: copy this file in the mu-plugins folder of your WordPress installation if you have problems with the real cron service. Check the new cron URL from the settings page, tab "Cron"
Version: 1.0
