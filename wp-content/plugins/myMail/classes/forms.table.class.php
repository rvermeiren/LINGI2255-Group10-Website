...
<?php
	...
	public function column_default( $item, $column_name ) {
		...
		case 'name':
			...
			if ( mymail_option( 'profile_form', 0 ) == $item->ID ) {
				echo '<span class="dashicons-before dashicons-admin-users" title="' . __( 'This form is used for user profile updates', 'mymail' ) . '"></span>';
			}
