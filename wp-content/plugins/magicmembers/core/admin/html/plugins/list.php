	...
	<div class="table">
		...
		<div class="row ">
			...
			<div class="cell textalignleft">	
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][membership_type]" class="width150px">
		...
		<div class="row ">
			...
			<div class="cell textalignleft">	
				...
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][duration_type]" class="width100px">
		...
		<div class="row ">
			...
			<div class="cell width5px">:</div>
			<div class="cell textalignleft">	
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][num_cycles]" class="width80px">		
		...
		<div class="row ">
			...
			<div class="cell width5px">:</div>
			<div class="cell textalignleft">	
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][role]" class="width120px">
				<?php						
		...
		<div class="row ">
			...
			<div class="cell width5px">:</div>
			<div class="cell textalignleft">	
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][active]" class="width60px">
		...
		<div class="row pack_trial_<?php echo ($data['pack_ctr']-1) . ' ' . (!(int)$data['pack']['trial_on'] ? 'displaynone' : '');?>">
			<div class="cell width125px">	
				<select name="packs[<?php echo ($data['pack_ctr']-1) ?>][trial_num_cycles]" class="width80px">		
				<?php 
				foreach (range(1, 99) as $i) :
					echo '<option value="' . $i . '" ' . ($data['pack']['trial_num_cycles'] == $i ? 'selected="selected"':'') . '>' . $i . '</option>';
				endforeach;?>
				</select>
				<div class="tips width520px"><?php _e('Please use "Trial Occurrences" to configure number of times "Subscription Package Duration" to be treated as "Trial Period". Authorize.Net Payment Gateway requires you to set up "Trial Period" same as "Subscription Package Duration" .', 'mgm')?></div>
