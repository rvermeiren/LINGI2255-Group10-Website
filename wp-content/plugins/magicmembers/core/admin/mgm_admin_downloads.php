 ...
 */
 class mgm_admin_downloads extends mgm_controller{
	...
	function index(){		
		...
		$data = array();			
		// load template view
		$this->load->template('downloads/index', array('data'=>$data));
	}
	...
	function lists(){		
		...
		// load view
		$this->load->template('downloads/lists', array('data'=>$data));
	}
	...
	function add(){		
		...
		// load template view
		$this->load->template('downloads/add', array('data'=>$data));
	}
	...
	function editor(){
		...
		// load template view
		$this->load->template('downloads/editor_options', array('data'=>$data));		
	}
	...
	function shortcodes(){
		...
		// load template view
		$this->load->template('shortcodes/shortcode_options', array('data'=>$data));			
	}		
 }
