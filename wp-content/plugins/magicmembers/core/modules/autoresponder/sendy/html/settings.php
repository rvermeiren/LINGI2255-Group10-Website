...
<div id="module_settings_<?php echo $data['module']->code?>">
	...
	<form name="frmmod_<?php echo $data['module']->code?>" id="frmmod_<?php echo $data['module']->code?>" action="admin-ajax.php?action=mgm_admin_ajax_action&page=mgm/admin/autoresponders&method=module_settings&module=<?php echo $data['module']->code?>">
		...
		<p><div class="tips width95"><?php _e('Enable/Disable the Sendy module.','mgm'); ?></div></p>
		...
		<div class="table widefatDiv">
			...
			<div class="row brBottom alternate">
				...
				<div class="cell textalignleft width50 brCellBorderLeft">
					...
					<input type="text" name="setting[api_key]" value="<?php echo $data['module']->setting['api_key']; ?>" size="40" />						
				...
				<div class="cell">
					...
					<p>
						...
						<div class="tips width90">
							...
							<?php _e('Url to Sendy subscribe file, note: Sendy requires local installation.','mgm'); ?><br/>

							<b><?php _e('E.g.','mgm'); ?>:</b> 

							<?php _e('http://your_sendy_installation/subscribe','mgm'); ?>
				...
				<div class="cell">
					...
					<p>
						...
						<div class="tips width90">
							...
							<?php _e('Url to Sendy unsubscribe file, note: Sendy requires local installation.','mgm'); ?><br/>

							<b><?php _e('E.g.','mgm'); ?>:</b> 

							<?php _e('http://your_sendy_installation/unsubscribe','mgm'); ?>
		...
		<div class="table widefatDiv">
			...
			<div class="row headrow">
				...
				<div class="cell theadDivCell width50 textalignleft">
		    		...
		    		<b><?php _e('Sendy List/Group','mgm')?></b>
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			messages: {		
				'setting[form_id]': '<?php _e('Please enter sendy api key.','mgm')?>',
				
				'setting[list_id]': '<?php _e('Please enter sendy list id.','mgm')?>',

				'setting[post_url]': '<?php _e('Please enter sendy post url.','mgm')?>'
