...
<div id="module_settings_<?php echo $data['module']->code?>">
	<form name="frmmod_<?php echo $data['module']->code?>" id="frmmod_<?php echo $data['module']->code?>" action="admin-ajax.php?action=mgm_admin_ajax_action&page=mgm/admin/autoresponders&method=module_settings&module=<?php echo $data['module']->code?>">
		...
		<p><div class="tips width95"><?php _e('Enable/Disable the iContact module.','mgm'); ?></div></p>
		<p>&nbsp;</p>
		...
		<div class="table widefatDiv">
			<div class="row headrow">
				<div class="cell theadDivCell width50 textalignleft">
		    		<b><?php _e('iContact Field','mgm')?></b>
				</div>
				<div class="cell theadDivCell width50 textalignleft brCellBorderLeft">
		    		<b><?php _e('Value','mgm')?></b>
				</div>
			</div>
			<div class="row brBottom mgm_font_size12px">
				<div class="cell width50 textalignleft alternate">
					<b><?php _e('Client Id','mgm'); ?></b>
				</div>
				<div class="cell textalignleft width50 brCellBorderLeft">
					<input type="text" name="setting[clientid]" value="<?php echo $data['module']->setting['clientid']; ?>"  size="40"/>
				</div>
			</div>
			<div class="row brBottom mgm_font_size12px">
				<div class="cell width50 textalignleft ">
			...
			<div class="row brBottom alternate mgm_font_size12px">
				...
				<div class="cell textalignleft width50 brCellBorderLeft">
					<input type="text" name="setting[listid]" value="<?php echo $data['module']->setting['listid']; ?>"  size="40"/>
				</div>
			</div>
			<div class="row brBottom mgm_font_size12px">
				<div class="cell width50 textalignleft ">
				...
				<div class="cell textalignleft width50 brCellBorderLeft">
					<input type="text" name="setting[specialid]" value="<?php echo $data['module']->setting['specialid']; ?>"  size="40"/>
				</div>
			</div>
			<div class="row brBottom alternate mgm_font_size12px">
				<div class="cell width50 textalignleft ">
		...
		<div class="table widefatDiv">
			<div class="row headrow">
				<div class="cell theadDivCell width50 textalignleft">
		    		<b><?php _e('iContact List/Group','mgm')?></b>
				</div>
				<div class="cell theadDivCell width50 textalignleft brCellBorderLeft">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			rules: {			
				'setting[clientid]': 'required',
				'setting[formid]': 'required',
				'setting[listid]': 'required',
				'setting[specialid]': 'required'
			},
			messages: {		
				'setting[clientid]': '<?php _e('Please enter icontact client id.','mgm')?>',
				'setting[formid]': '<?php _e('Please enter icontact form id.','mgm')?>',
				'setting[listid]': '<?php _e('Please enter icontact list id.','mgm')?>',
				'setting[specialid]': '<?php _e('Please enter icontact special id.','mgm')?>'
			},
			errorClass: 'invalid'
		});							
	});	
