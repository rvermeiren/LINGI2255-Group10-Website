...
<div id="module_settings_<?php echo $data['module']->code?>">
	<form name="frmmod_<?php echo $data['module']->code?>" id="frmmod_<?php echo $data['module']->code?>" action="admin-ajax.php?action=mgm_admin_ajax_action&page=mgm/admin/autoresponders&method=module_settings&module=<?php echo $data['module']->code?>">
		...
		<p><div class="tips width95"><?php _e('Enable/Disable the infusionsoft module.','mgm'); ?></div></p>
		<p>&nbsp;</p>
		...
		<div class="table widefatDiv">
			<div class="row headrow">
				<div class="cell theadDivCell width50 textalignleft">
		    		<b><?php _e('Infusionsoft Field','mgm')?></b>
				</div>
				<div class="cell theadDivCell width50 textalignleft brCellBorderLeft">
		    		<b><?php _e('Value','mgm')?></b>
				</div>
			...
			<div class="row brBottom">
				...
				<div class="cell textalignleft width50 brCellBorderLeft">
					<input type="text" name="setting[app_name]" value="<?php echo $data['module']->setting['app_name']; ?>" size="40"/>						
				</div>
			</div>
			<div class="row brBottom">
				<div class="cell">
				...
				<div class="cell">
					<p>
						<div class="tips width90">
							<?php _e('Infusionsoft Api Key','mgm'); ?>
						</div>
					</p>
				</div>
			</div>			
		...
		<div class="tips width95">
			<?php _e('After updating api key & application name only Infusionsoft Tag/Group Ids are available.','mgm'); ?>
		</div>			
		<h3><b><?php _e('Membership Mappings','mgm')?></b></h3>
		<div class="table widefatDiv">
			<div class="row headrow">
				<div class="cell theadDivCell width50 textalignleft">
		    		<b><?php _e('Infusionsoft Tag/Group Id','mgm')?></b>
				</div>
				<div class="cell theadDivCell width50 textalignleft brCellBorderLeft">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			rules: {			
				...
				'setting[app_name]': 'required'
			},
			messages: {		
				'setting[list_id]': '<?php _e('Please enter infusionsoft list id.','mgm')?>',
				'setting[app_name]': '<?php _e('Please enter infusionsoft application name.','mgm')?>'
			},
			errorClass: 'invalid'
		});							
	});	
