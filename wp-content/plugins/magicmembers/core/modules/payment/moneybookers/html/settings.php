...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Moneybookers Pay to Email','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[pay_to_email]" id="setting_pay_to_email" value="<?php echo esc_html($data['module']->setting['pay_to_email']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Moneybookers primary email where the payment will be sent.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Moneybookers Merchant ID','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[merchant_id]" id="setting_merchant_id" value="<?php echo esc_html($data['module']->setting['merchant_id']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Moneybookers Merchant ID/ Customer ID, you can get this from Overview page. Will be used to secure the payment.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Moneybookers Secret Word','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[secret_word]" id="setting_secret_word" value="<?php echo esc_html($data['module']->setting['secret_word']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Moneybookers Secret Word, create this on Merchant Tools section on your Moneybookers account. Will be used to secure the payment.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Moneybookers language to use','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<select name="setting[language]" id="setting_language" class="width120px">
						<?php echo mgm_make_combo_options(mgm_get_languages(), $data['module']->setting['language'], MGM_KEY_VALUE)?>
					</select>							
					<p><div class="tips"><?php _e('Moneybookers language to use.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Merchant description','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[recipient_desc]" id="setting_recipient_desc" value="<?php echo esc_html($data['module']->setting['recipient_desc']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Merchant description shown on the gateway.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Merchant confirmation note','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[confirmation_note]" id="setting_confirmation_note" value="<?php echo esc_html($data['module']->setting['confirmation_note']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Merchant confirmation note shown on the gateway after payment.','mgm'); ?></div></p>
				</div>
			</div>
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Notify URL for capturing silent post data sent from Moneybookers. READONLY, only for information.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			messages: {		
				'setting[business_email]': {required:"<?php _e('Please enter Moneybookers business email.','mgm')?>",email:"<?php _e('Please enter valid email.','mgm')?>"}
			},
			errorClass: 'invalid'
		});			
		// attach uploader
