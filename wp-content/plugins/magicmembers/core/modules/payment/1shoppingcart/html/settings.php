...
<div id="module_settings_<?php echo $data['module']->code?>" class="module_settings">
	...
	<div class="table">
  		<div class="row">
    		<div class="cell">
	    		<p><b><?php _e('1ShoppingCart Merchant ID','mgm'); ?>:</b></p>
			</div>
		</div>
  		<div class="row">
  			<div class="cell">
				<input type="text" name="setting[merchant_id]" id="setting_merchant_id" value="<?php echo $data['module']->setting['merchant_id']; ?>" size="80"/>
				<p><div class="tips"><?php _e('1ShoppingCart Merchant ID.','mgm'); ?></div></p>
  			</div>
		</div>
  		<div class="row">
  			<div class="cell">
				<p><b><?php _e('1ShoppingCart Merchant API Key','mgm'); ?>:</b></p>
  			</div>
		</div>
  		<div class="row">
  			<div class="cell">
				<input type="text" name="setting[merchant_api_key]" id="setting_merchant_api_key" value="<?php echo $data['module']->setting['merchant_api_key']; ?>" size="80"/>
				<p><div class="tips"><?php _e('1ShoppingCart Merchant API Key.','mgm'); ?></div></p>
  			</div>
		</div>
		...
		<div class="row">
  		...
  		<div class="row">
  			<div class="cell">
				...
				<p><div class="tips"><?php _e('Notify URL for capturing silent post data sent from 1ShoppingCart. Version 1.0 READONLY, only for information.','mgm'); ?></div></p>
			</div>
		</div>
  		<div class="row">
  			<div class="cell">
				<p><b><?php _e('Thank You (Success) URL','mgm'); ?>:</b></p>
  			</div>
		</div>
  		<div class="row">
  			<div class="cell">
				<?php echo add_query_arg(array('status'=>'success'), $data['module']->setting['return_url'])?>																
				<p><div class="tips"><?php _e('Success URL for all products. Set this on all products created in 1ShoppingCart. READONLY, only for information.','mgm'); ?></div></p>
  			</div>
		</div>
		<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Denial URL for all sub accounts. Set this on all products created in 1ShoppingCart. READONLY, only for information.','mgm'); ?></div></p>		
				</div>
			</div>
  		<div class="row">
  			<div class="cell">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			rules: {			
				...
				'setting[merchant_api_key]': "required"
			},
			messages: {			
				'setting[merchant_id]': "<?php _e('Please enter 1ShoppingCart merchant id.','mgm')?>",
				'setting[merchant_api_key]': "<?php _e('Please enter 1ShoppingCart merchant api key.','mgm')?>"
			},
			errorClass: 'invalid'
		});	
		// attach uploader
