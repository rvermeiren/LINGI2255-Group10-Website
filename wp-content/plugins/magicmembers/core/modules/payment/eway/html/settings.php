...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Eway Customer ID','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[customer_id]" id="setting_customer_id" value="<?php echo $data['module']->setting['customer_id']; ?>" size="30"/>
					<p><div class="tips"><?php _e('Eway Customer ID.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Eway Gateway Username','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[username]" id="username" value="<?php echo $data['module']->setting['username']; ?>" size="30"/>
					<p><div class="tips"><?php _e('Eway Gateway Username required for "Managed Rebill Web services".','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Eway Gateway Password','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[password]" id="password" value="<?php echo $data['module']->setting['password']; ?>" size="30"/>
					<p><div class="tips"><?php _e('Eway Gateway Password required for "Managed Rebill Web services".','mgm'); ?></div></p>
				</div>
			</div>
			...
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Eway timeout','mgm'); ?>:</b></p>
				</div>
			</div>			
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[timeout]" id="timeout" value="<?php echo $data['module']->setting['timeout']; ?>" size="30"/>
					<p><div class="tips"><?php _e('Remote post timeout / Eway timeout','mgm'); ?></div></p>
				</div>
			</div>			
			<div class="row">
				<div class="cell">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			rules: {			
				'setting[customer_id]': "required"
			},
			messages: {			
				'setting[customer_id]': "<?php _e('Please enter Eway Customer ID.','mgm')?>"
			},
			errorClass: 'invalid'
		});	
		// attach uploader
