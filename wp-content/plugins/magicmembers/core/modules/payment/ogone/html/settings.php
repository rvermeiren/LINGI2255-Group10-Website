...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Ogone PSPID','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[pspid]" id="setting_pspid" value="<?php echo esc_html($data['module']->setting['pspid']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Ogone PSPID/MerchantID where the payment will be sent.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Ogone SHA-1 Passphrase','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Ogone SHA-1 Passphrase to verify the payment.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Ogone Language','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Ogone language to use.','mgm'); ?></div></p>
				</div>
			</div>
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Notify URL for capturing silent post data sent from ogone. READONLY, only for information.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			messages: {		
				'setting[pspid]': {required:"<?php _e('Please enter ogone pspid.','mgm')?>"},
				'setting[sha1_passphrase]': {required:"<?php _e('Please enter ogone sha1 passphrase.','mgm')?>"}
			},
			errorClass: 'invalid'
		});			
		// attach uploader
