...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			...
			<div class="row">
				<div class="cell">
					<p><b><?php _e('PayPal IPN Environment and Endpoint SHA-1 to SHA-256 Switching','mgm'); ?>:</b></p>				
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<select name="setting[ipn_switch]" id="setting_ipn_switch" class="width400px">
						<?php echo mgm_make_combo_options(array('ipnpb'=>__('ipnpb.paypal.com SHA-1 to SHA-256  October 1, 2016','mgm'),'paypal'=>__('www.paypal.com  - SHA-1 to SHA-256 September 9-30, 2015','mgm')),  $data['module']->setting['ipn_switch'], MGM_KEY_VALUE)?>
					</select>						
					<p><div class="tips"><?php _e('Switch between PayPal IPN Environment and Endpoint SHA-1 to SHA-256 Switching mode to your payments. Not all modules supports this feature.','mgm'); ?></div></p>
				</div>
			</div>
