		...
		<div class="table">
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Paypal API Username generated in your Paypal Pro account.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Paypal API Password generated in your Paypal Pro account.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Paypal API Signature generated in your Paypal Pro account.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			messages: {		
				'setting[username]': "<?php _e('Please enter api username.','mgm')?>",
				'setting[password]': "<?php _e('Please enter api password.','mgm')?>",
				'setting[signature]': "<?php _e('Please enter api signature.','mgm')?>"
			},
			errorClass: 'invalid'
		});			
		// attach uploader
