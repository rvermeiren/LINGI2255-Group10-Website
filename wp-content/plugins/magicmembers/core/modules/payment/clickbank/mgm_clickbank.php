...
class mgm_clickbank extends mgm_payment{
	...
	function _decrypt_ipn6_notification() {
		...
		//log
		mgm_log("Message : ".print_r($message,true) ,__FUNCTION__);
		// Pull out the encrypted notification and the initialization vector for
		// AES/CBC/PKCS5Padding decryption
		$encrypted_notification = $message->{'notification'};		
		//log
		mgm_log("ENCRYPTED NOTIFICATION : ".print_r($encrypted_notification,true) ,__FUNCTION__);
		
		$initialization_vector = $message->{'iv'};
		//log
		mgm_log("INITIALIZATION VECTOR: ".print_r($initialization_vector,true) ,__FUNCTION__);	
		...
		//log
		mgm_log("Decrypted : ".print_r($decrypted_notification,true) ,__FUNCTION__);	
		...
		//log
		mgm_log("Decrypted json string : ".print_r($decrypted_json_string,true) ,__FUNCTION__);	
		// convert the decrypted string to a JSON object
		$noification_data = json_decode($decrypted_json_string);	
		//log
		mgm_log("Noification data: ".print_r($noification_data,true) ,__FUNCTION__);
		//return
