...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			<div class="row">
				<div class="cell">
					<p><b><?php _e('ClickBank Username','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[username]" id="setting_username" value="<?php echo $data['module']->setting['username']; ?>" size="30"/>
					<p><div class="tips"><?php _e('ClickBank Username.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('ClickBank Secret Key','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[secret_key]" id="setting_secret_key" value="<?php echo $data['module']->setting['secret_key']; ?>" size="30"/>
					<p><div class="tips"><?php _e('ClickBank Secret Key.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('ClickBank Skin','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[cbskin]" id="setting_cbskin" value="<?php echo $data['module']->setting['cbskin']; ?>" size="30"/>
					<p><div class="tips"><?php _e('ClickBank Skin.','mgm'); ?></div></p>
				</div>
			</div>
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Notify URL for capturing silent post data sent from ClickBank. Version 1.0 READONLY, only for information.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Success/Failure URL for all products. Set this on all products created in ClickBank. READONLY, only for information.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
...
<script language="javascript">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			messages: {			
				'setting[username]': "<?php _e('Please enter ClickBank username.','mgm')?>",
				'setting[secret_key]': "<?php _e('Please enter ClickBank secret key.','mgm')?>"
			},
			errorClass: 'invalid'
		});	
		// attach uploader
