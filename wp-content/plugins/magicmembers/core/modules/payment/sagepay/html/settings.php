...
<div id="module_settings_<?php echo $data['module']->code?>">
	<?php mgm_box_top($data['module']->name. ' Settings');?>
		...
		<div class="table">
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Sagepay Vendor Code','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[vendor]" id="setting_vendor" value="<?php echo esc_html($data['module']->setting['vendor']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Sagepay Vendor Code.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<p><b><?php _e('Sagepay Encryption Key','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<input type="text" name="setting[encryption_key]" id="setting_encryption_key" value="<?php echo esc_html($data['module']->setting['encryption_key']); ?>" size="50"/>
					<p><div class="tips"><?php _e('Sagepay Encryption Key to create post crypt.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
			...
			<div class="row">
				<div class="cell">
					<p><b><?php _e('SagePay protocol','mgm'); ?>:</b></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
					<select name="setting[protocol]" id="setting_protocol" class="width200px">
						<?php echo mgm_make_combo_options(array('2.23'=>__('2.23','mgm'),'3.00'=>__('3.00','mgm')), $data['module']->setting['protocol'], MGM_KEY_VALUE)?>
					</select>						
					<p><div class="tips"><?php _e('SagePay protocol can upgrade 2.23 to 3.00','mgm'); ?></div></p>
				</div>
			</div>		
			...
			<div class="row">
				<div class="cell">
					<select name="status" class="width100px">
						<?php echo mgm_make_combo_options(array('test'=>__('TEST','mgm'),'live'=>__('LIVE','mgm'),'simulator'=>'SIMULATOR'), $data['module']->status, MGM_KEY_VALUE)?>
					</select>						
			...
			<div class="row">
				<div class="cell">
					...
					<p><div class="tips"><?php _e('Notify URL for capturing silent post data sent from sagepay. READONLY, only for information.','mgm'); ?></div></p>
				</div>
			</div>
			<div class="row">
				<div class="cell">
	...
	jQuery(document).ready(function(){   
		...
		jQuery("#frmmod_<?php echo $data['module']->code?>").validate({
			...
			rules: {			
				...
				'setting[encryption_key]': "required"				
			},
			messages: {		
				'setting[vendor]': "<?php _e('Please enter sagepay vendor account.','mgm')?>",
				'setting[encryption_key]': "<?php _e('Please enter sagepay encryption key.','mgm')?>"
