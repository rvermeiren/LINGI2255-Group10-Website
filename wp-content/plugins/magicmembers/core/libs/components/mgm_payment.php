...
class mgm_payment extends mgm_component{
	...
	var $supports_card_token_save = 'N';
	// card update feature
	var $supports_card_update = 'N';
	// rebill status check delay
	var $rebill_status_check_delay = false;
	...
	function has_product_map(){
	  ...
	  */
	 function is_rebill_status_check_delayed(){
	 ...
	 * @todo
	 */
	 function _change_payment_processing_page_title( $title ){
	 	// return
	...
	function _get_transaction_id($key='custom', $source=null){
	  ...
	  */
	function _get_alternate_transaction_id($key='custom'){
		// var
		$tran_id = '';
	 ...
	 * @return boolean
	 */
	function is_payment_email_sent($tran_id) {			
	 ...
	 * @param int $tran_id
	 */
	function record_payment_email_sent($tran_id) {		
		if(!is_numeric($tran_id))
			return;
	...
	function _update_card_ccfields($user=NULL,$html_type='div',$pack_id=NULL){
		// data
		$data = array();
		// name, amount
		$data['name'] = $data['billing_info'] = $purchase_desc = '';
	 ...
	 * @param unknown_type $calling_fun
	 */
	function validate_update_cc_fields_process($calling_func = 'process_update_credit_card_html', $return = true) {
	 ...
	 * @return string
	 */ 
	function get_subscription_cancel_key( $member ){
		// default
	 ...
	 * @since 2.7
	 */	
	function set_extend_module_base_dir($module_base_dir=''){
		// set
		if($module_base_dir) return $this->module_base_dir = $module_base_dir;		
		// set default
	 ...
	 * @since 2.7
	 */	
	function set_extend_module_base_url($module_base_url=''){
		// set
		if($module_base_url) return $this->module_base_url = $module_base_url;
		// set default		
	 ...
	 * @since 2.7
	 */
	function get_extend_module_base_dir(){
		// check
