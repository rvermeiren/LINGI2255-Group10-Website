...
class mgm_schedular extends mgm_object{
	...
	function get_defined_schedules(){
		...
		return array('every15minute'  => 'mgm_every15minute_schedule',// every 15 minutes
	...
	function push_event( $recurrence, $callback ){
		...
		if( isset($return) && $return == true ){
			...
			// log
			mgm_log( 'Schedule '. $event_callback .' executed at '. $current_date['date'], 'mgm_schedular_push_event');
		}	
	}
